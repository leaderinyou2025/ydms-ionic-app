  ...
  public async onSubmit(): Promise<void> {
    ...
    try {
      ...
      if (!changePasswordResult) {
        this.showToast(this.translate.instant(TranslateKeys.ERROR_INVALID_CURRENT_PASS), IonicColors.DANGER);
        return;
      }

      // Update local storage pass
      this.authService.saveAuthToken(newPassword);
      this.showToast(this.translate.instant(TranslateKeys.TOAST_CHANGE_PASS_SUCCESS), IonicColors.SUCCESS);
