export enum TranslateKeys {
  ...
  // AREA OF EXPERTISE
  AREA_OF_EXPERTISE_EMOTION = 'AREA_OF_EXPERTISE.emotion',
  AREA_OF_EXPERTISE_CONFLICT = 'AREA_OF_EXPERTISE.conflict',
  AREA_OF_EXPERTISE_COMMUNICATION = 'AREA_OF_EXPERTISE.communication',
  ARAEA_OF_EXPERTISE_DISCOVERY = 'AREA_OF_EXPERTISE.discovery',

  // ACHIEVEMENT
  BADGE_NO_ACHIEVEMENTS_YET = 'ACHIEVEMENT.badge_no_achievements_yet',
  ...
  // EMOTION STREAK
  EMOTION_STREAK_CURRENT = 'EMOTION_STREAK.current',
  EMOTION_STREAK_LONGEST = 'EMOTION_STREAK.longest',
  EMOTION_STREAK_DAYS_3 = 'EMOTION_STREAK.days_3',
  EMOTION_STREAK_DAYS_5 = 'EMOTION_STREAK.days_5',
  EMOTION_STREAK_DAYS_7 = 'EMOTION_STREAK.days_7',
  EMOTION_STREAK_DAYS_15 = 'EMOTION_STREAK.days_15',
  EMOTION_STREAK_DAYS_28 = 'EMOTION_STREAK.days_28',

  // EMOTION SHARE
  EMOTION_SHARE_TARGET_CLASS = 'EMOTION_SHARE.target_class',
  EMOTION_SHARE_TARGET_FRIENDS = 'EMOTION_SHARE.target_friends',
  EMOTION_SHARE_TARGET_TEACHERS = 'EMOTION_SHARE.target_teachers',
  EMOTION_SHARE_TARGET_FAMILY = 'EMOTION_SHARE.target_family',

  // DAILY EMOTION JOURNAL
  DAILY_EMOTION_JOURNAL_NO_ENTRIES = 'DAILY_EMOTION_JOURNAL.no_entries',
  DAILY_EMOTION_JOURNAL_NO_CAPTION = 'DAILY_EMOTION_JOURNAL.no_caption',
  DAILY_EMOTION_JOURNAL_SHARED_WITH = 'DAILY_EMOTION_JOURNAL.shared_with',
  DAILY_EMOTION_JOURNAL_DATE_HAS_ENTRY = 'DAILY_EMOTION_JOURNAL.date_has_entry',
  DAILY_EMOTION_JOURNAL_ENTRY_CREATED = 'DAILY_EMOTION_JOURNAL.entry_created',
  DAILY_EMOTION_JOURNAL_ENTRY_CREATION_FAILED = 'DAILY_EMOTION_JOURNAL.entry_creation_failed',
  DAILY_EMOTION_JOURNAL_ADD_ENTRY = 'DAILY_EMOTION_JOURNAL.add_entry',
  DAILY_EMOTION_JOURNAL_SELECT_EMOTION = 'DAILY_EMOTION_JOURNAL.select_emotion',
  DAILY_EMOTION_JOURNAL_ADD_CAPTION = 'DAILY_EMOTION_JOURNAL.add_caption',
  DAILY_EMOTION_JOURNAL_CAPTION_PLACEHOLDER = 'DAILY_EMOTION_JOURNAL.caption_placeholder',
  DAILY_EMOTION_JOURNAL_SHARE_WITH = 'DAILY_EMOTION_JOURNAL.share_with',

  // CALENDAR
  CALENDAR_TODAY = 'CALENDAR.today',
  CALENDAR_SUNDAY_SHORT = 'CALENDAR.sunday_short',
  CALENDAR_MONDAY_SHORT = 'CALENDAR.monday_short',
  CALENDAR_TUESDAY_SHORT = 'CALENDAR.tuesday_short',
  CALENDAR_WEDNESDAY_SHORT = 'CALENDAR.wednesday_short',
  CALENDAR_THURSDAY_SHORT = 'CALENDAR.thursday_short',
  CALENDAR_FRIDAY_SHORT = 'CALENDAR.friday_short',
  CALENDAR_SATURDAY_SHORT = 'CALENDAR.saturday_short',
  CALENDAR_JANUARY = 'CALENDAR.january',
  CALENDAR_FEBRUARY = 'CALENDAR.february',
  CALENDAR_MARCH = 'CALENDAR.march',
  CALENDAR_APRIL = 'CALENDAR.april',
  CALENDAR_MAY = 'CALENDAR.may',
  CALENDAR_JUNE = 'CALENDAR.june',
  CALENDAR_JULY = 'CALENDAR.july',
  CALENDAR_AUGUST = 'CALENDAR.august',
  CALENDAR_SEPTEMBER = 'CALENDAR.september',
  CALENDAR_OCTOBER = 'CALENDAR.october',
  CALENDAR_NOVEMBER = 'CALENDAR.november',
  CALENDAR_DECEMBER = 'CALENDAR.december',
